// MEDIUM https://www.hackerrank.com/challenges/magic-square-forming/problem
...
TEST(FormingMagicSquare, example)
{
    EXPECT_EQ(7, formingMagicSquare({ {5, 3, 4}, {1, 5, 8}, {6, 4, 2    } }));
}
