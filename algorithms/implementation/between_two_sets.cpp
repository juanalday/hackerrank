// EASY https://www.hackerrank.com/challenges/between-two-sets/problem
...
TEST(BetweenTwoSets, findFactors)
{
    EXPECT_EQ(std::vector<int>({1, 2, 3, 4, 6, 12}), findFactors(12));
}

TEST(BetweenTwoSets, example)
{
    EXPECT_EQ(2, getTotalX({2,6}, {24, 36}));
}

TEST(BetweenTwoSets, sample0)
{
    EXPECT_EQ(3, getTotalX({ 2,4 }, { 16, 32, 96 }));
}

TEST(BetweenTwoSets, sample1)
{
    EXPECT_EQ(2, getTotalX({ 3,4 }, { 24, 48 }));
}

TEST(BetweenTwoSets, case0)
{
    EXPECT_EQ(3, getTotalX({2,4}, { 16, 32, 96}));
}

TEST(BetweenTwoSets, case7)
{
    EXPECT_EQ(8, getTotalX({1 }, {72,48}));
}

TEST(BetweenTwoSets, case8)
{
    EXPECT_EQ(2, getTotalX({ 3,4 }, { 24, 48 }));
}