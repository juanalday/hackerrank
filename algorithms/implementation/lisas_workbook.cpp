// EASY https://www.hackerrank.com/challenges/lisa-workbook/problem
...
TEST(LisasWorkbook, example)
{
	EXPECT_EQ(1, workbook(3, { 4,2 }));
}

TEST(LisasWorkbook, sample0)
{
	EXPECT_EQ(4, workbook(3, { 4,2,6,1,10 }));
}
TEST(LisasWorkbook, sample1)
{
	EXPECT_EQ(8, workbook(5, { 3, 8, 15, 11, 14, 1, 9, 2, 24, 31 }));
}

TEST(LisasWorkbook, case0)
{
	EXPECT_EQ(4, workbook(3, { 4,2,6,1,10 }));
}
TEST(LisasWorkbook, case1)
{
	EXPECT_EQ(8, workbook(5, { 3, 8, 15, 11, 14, 1, 9, 2, 24, 31 }));
}

TEST(LisasWorkbook, case10)
{
