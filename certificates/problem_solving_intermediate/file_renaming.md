...
There are 4 ways to achieve *newName* = "ccc" from *oldName* = "cccc". These are "ccc", "ccc", "ccc", "ccc". 
...
There is no way to get *newName* = "abc" from deleting characters from *oldName* = "abba". 
